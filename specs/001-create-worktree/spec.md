...
- Q: VS Code 以外のエディター対応範囲は？ → A: 一般的なエディター（VS Code、vim、emacs、nano、sublime、IntelliJ IDEA）のプリセットを提供
...
- **FR-005**: システムはオプションでエディター（VS Code、vim、emacs、nano、sublime、IntelliJ IDEA）を自動起動できる必要がある。これらの一般的なエディターのプリセットを提供する
...
- **EditorConfig**: エディター設定を表現する。エディター種類（VS Code、vim、emacs、nano、sublime、IntelliJ IDEA のプリセット）、起動コマンド、パスの情報を持つ
...
4. **エディター検出**: 一般的なエディター（VS Code、vim、emacs、nano、sublime、IntelliJ IDEA）は標準的なインストールパスで検出可能と仮定する
